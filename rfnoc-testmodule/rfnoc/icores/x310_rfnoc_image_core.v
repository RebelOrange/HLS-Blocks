...
// File generated on: 2024-07-04T13:00:51.342878
...
module rfnoc_image_core #(
  ...
  chdr_crossbar_nxn #(
    .PORT_W         (PORT_W),
    .NPORTS         (8),
    .CHDR_WIDTHS    ({EP4_W, EP3_W, EP2_W, EP1_W, EP0_W, PCIE_W, ETH1_W, ETH0_W}),
    .DEFAULT_PORT   (0),
    .ROUTES         ({ 8'b11111111,
                       8'b11111111,
                       8'b11111111,
  ...
  wire [31:0] m_testblock0_ctrl_tdata,  s_testblock0_ctrl_tdata;
  wire        m_testblock0_ctrl_tlast,  s_testblock0_ctrl_tlast;
  wire        m_testblock0_ctrl_tvalid, s_testblock0_ctrl_tvalid;
  wire        m_testblock0_ctrl_tready, s_testblock0_ctrl_tready;
  ...
  axis_ctrl_crossbar_nxn #(
    ...
    .s_axis_tdata     ({m_testblock0_ctrl_tdata , m_radio1_ctrl_tdata , m_ddc1_ctrl_tdata , m_duc1_ctrl_tdata , m_radio0_ctrl_tdata , m_ddc0_ctrl_tdata , m_duc0_ctrl_tdata , m_ep0_ctrl_tdata , m_core_ctrl_tdata }),
    .s_axis_tvalid    ({m_testblock0_ctrl_tvalid, m_radio1_ctrl_tvalid, m_ddc1_ctrl_tvalid, m_duc1_ctrl_tvalid, m_radio0_ctrl_tvalid, m_ddc0_ctrl_tvalid, m_duc0_ctrl_tvalid, m_ep0_ctrl_tvalid, m_core_ctrl_tvalid}),
    .s_axis_tlast     ({m_testblock0_ctrl_tlast , m_radio1_ctrl_tlast , m_ddc1_ctrl_tlast , m_duc1_ctrl_tlast , m_radio0_ctrl_tlast , m_ddc0_ctrl_tlast , m_duc0_ctrl_tlast , m_ep0_ctrl_tlast , m_core_ctrl_tlast }),
    .s_axis_tready    ({m_testblock0_ctrl_tready, m_radio1_ctrl_tready, m_ddc1_ctrl_tready, m_duc1_ctrl_tready, m_radio0_ctrl_tready, m_ddc0_ctrl_tready, m_duc0_ctrl_tready, m_ep0_ctrl_tready, m_core_ctrl_tready}),
    .m_axis_tdata     ({s_testblock0_ctrl_tdata , s_radio1_ctrl_tdata , s_ddc1_ctrl_tdata , s_duc1_ctrl_tdata , s_radio0_ctrl_tdata , s_ddc0_ctrl_tdata , s_duc0_ctrl_tdata , s_ep0_ctrl_tdata , s_core_ctrl_tdata }),
    .m_axis_tvalid    ({s_testblock0_ctrl_tvalid, s_radio1_ctrl_tvalid, s_ddc1_ctrl_tvalid, s_duc1_ctrl_tvalid, s_radio0_ctrl_tvalid, s_ddc0_ctrl_tvalid, s_duc0_ctrl_tvalid, s_ep0_ctrl_tvalid, s_core_ctrl_tvalid}),
    .m_axis_tlast     ({s_testblock0_ctrl_tlast , s_radio1_ctrl_tlast , s_ddc1_ctrl_tlast , s_duc1_ctrl_tlast , s_radio0_ctrl_tlast , s_ddc0_ctrl_tlast , s_duc0_ctrl_tlast , s_ep0_ctrl_tlast , s_core_ctrl_tlast }),
    .m_axis_tready    ({s_testblock0_ctrl_tready, s_radio1_ctrl_tready, s_ddc1_ctrl_tready, s_duc1_ctrl_tready, s_radio0_ctrl_tready, s_ddc0_ctrl_tready, s_duc0_ctrl_tready, s_ep0_ctrl_tready, s_core_ctrl_tready}),
    .deadlock_detected()
  );
  ...
  wire                    testblock0_ce_clk;
  wire [BLOCK_CHDR_W-1:0] s_testblock0_in_0_tdata ;
  wire                    s_testblock0_in_0_tlast ;
  wire                    s_testblock0_in_0_tvalid;
  wire                    s_testblock0_in_0_tready;
  wire [BLOCK_CHDR_W-1:0] m_testblock0_out_0_tdata ;
  wire                    m_testblock0_out_0_tlast ;
  wire                    m_testblock0_out_0_tvalid;
  wire                    m_testblock0_out_0_tready;
  ...
  rfnoc_block_testblock #(
    ...
    .rfnoc_chdr_clk      (rfnoc_chdr_clk),
    .rfnoc_ctrl_clk      (rfnoc_ctrl_clk),
    .ce_clk              (testblock0_ce_clk),
    .rfnoc_core_config   (rfnoc_core_config[512*7-1:512*6]),
    .rfnoc_core_status   (rfnoc_core_status[512*7-1:512*6]),
    .s_rfnoc_chdr_tdata  ({s_testblock0_in_0_tdata }),
    .s_rfnoc_chdr_tlast  ({s_testblock0_in_0_tlast }),
    .s_rfnoc_chdr_tvalid ({s_testblock0_in_0_tvalid}),
    .s_rfnoc_chdr_tready ({s_testblock0_in_0_tready}),
    .m_rfnoc_chdr_tdata  ({m_testblock0_out_0_tdata }),
    .m_rfnoc_chdr_tlast  ({m_testblock0_out_0_tlast }),
    .m_rfnoc_chdr_tvalid ({m_testblock0_out_0_tvalid}),
    .m_rfnoc_chdr_tready ({m_testblock0_out_0_tready}),
    .s_rfnoc_ctrl_tdata  (s_testblock0_ctrl_tdata),
    .s_rfnoc_ctrl_tlast  (s_testblock0_ctrl_tlast),
    .s_rfnoc_ctrl_tvalid (s_testblock0_ctrl_tvalid),
    .s_rfnoc_ctrl_tready (s_testblock0_ctrl_tready),
    .m_rfnoc_ctrl_tdata  (m_testblock0_ctrl_tdata),
    .m_rfnoc_ctrl_tlast  (m_testblock0_ctrl_tlast),
    .m_rfnoc_ctrl_tvalid (m_testblock0_ctrl_tvalid),
    .m_rfnoc_ctrl_tready (m_testblock0_ctrl_tready)
  );
  ...
  assign s_testblock0_in_0_tdata = m_ep4_out0_tdata;
  assign s_testblock0_in_0_tlast = m_ep4_out0_tlast;
  assign s_testblock0_in_0_tvalid = m_ep4_out0_tvalid;
  assign m_ep4_out0_tready = s_testblock0_in_0_tready;

  assign s_ep4_in0_tdata = m_testblock0_out_0_tdata;
  assign s_ep4_in0_tlast = m_testblock0_out_0_tlast;
  assign s_ep4_in0_tvalid = m_testblock0_out_0_tvalid;
  assign m_testblock0_out_0_tready = s_ep4_in0_tready;
  ...
  assign testblock0_ce_clk = ce_clk;
